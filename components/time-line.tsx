                    ...
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-1 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-10 mb-5 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-full text-center">{data.date}</time>
